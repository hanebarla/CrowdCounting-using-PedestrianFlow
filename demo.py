...
from lib.opticalflow import OptFlow
...
def demo(args, start, end):
    ...
    DemoImg.save_fig(name=os.path.join(args.savefolder, 'demo-{}.png'.format(int(start))))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--savefolder', default="/home/data/Demos/CrowdFlow/")
    ...
    if args.dataset == "CrowdFlow" and args.StaticFF == 0 and args.DynamicFF == 0:
        args.savefolder = os.path.join(args.savefolder, "cf_{}_{}".format(args.cf, args.cod))
